<?php $title='Modifier Staigere'; ?>
<?php ob_start();?>
<form method="post" action="index.php?action=editini">
<div class="mb-3">
    <input hidden type="text" class="form-control" id="exampleInputEmail1" name="id" value="<?php echo $_GET['id'] ?>">
  </div>
  <div class="mb-3">
